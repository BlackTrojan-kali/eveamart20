        ...
        <div class="p-3  block w-11/12">
            ...
            <div class=" p-4 ">
                ...
                <div class="  block mt-6">
                    ...
                    <input type="text" class="font-thin rounded-lg h-14 w-full border-gray-300 mt-2" placeholder="Entrez votre addresse email">
                </div>
                <div class=" block mt-6">
                    <label for="Password" class="font-bold">Mot de passe:</label> <br>
                    <input type="password" class=" font-thin rounded-lg h-14 w-full border-gray-300 mt-2" placeholder="entrez votre mot de passe">
                </div>
